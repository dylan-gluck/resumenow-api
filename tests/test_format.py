...
def test_format_resume_success(mock_client):
    ...
    mock_response.parsed = {
        ...
        "work_experience": [],
        "technical_skills": {
            "programming_languages": [{"name": "Python"}, {"name": "TypeScript"}],
            "frameworks_libraries": [{"name": "FastAPI"}, {"name": "TensorFlow"}],
        },
    }
    ...
    resume_data = {
        ...
        "technical_skills": {
            ...
            "frameworks_libraries": [{"name": "FastAPI"}, {"name": "React"}],
        },
    }
    ...
    # Make the request
    response = client.put(
        "/format", json={"resume": resume_data, "job_description": job_description}
    )
...
def test_format_resume_invalid_input(mock_client):
    ...
    response = client.put(
        "/format",
        json={"resume": {"invalid": "data"}, "job_description": "Job description"},
    )
